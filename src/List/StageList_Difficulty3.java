...
public class StageList_Difficulty3 {
	...
	public static Stage Stage1() {
		...
		BasicUnit enemyUnit2 = new BasicUnit("Demon Boar", "Saber", stats);

		stats = new int[] { getHP(2000), 15, getAttack(200), 5, 100, 5, 0 };
		BasicUnit enemyUnit3 = new BasicUnit("Demon Boar", "Berserker", stats);

		stats = new int[] { getHP(2000), 15, getAttack(200), 5, 100, 5, 0 };
		BasicUnit enemyUnit4 = new BasicUnit("Demon Boar", "Saber", stats);

		stats = new int[] { getHP(2000), 15, getAttack(200), 5, 100, 5, 0 };
		BasicUnit enemyUnit5 = new BasicUnit("Demon Boar", "Saber", stats);
